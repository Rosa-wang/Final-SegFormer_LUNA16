...
OUTPUT_PATH = '/root/autodl-tmp/preprocessed_data'
...
BLOCK_SIZE = 128
COORDS_CUBE_SIZE = 128
# COORDS_CUBE_SIZE = 32
TARGET_SHAPE = (COORDS_CUBE_SIZE, COORDS_CUBE_SIZE, COORDS_CUBE_SIZE)
